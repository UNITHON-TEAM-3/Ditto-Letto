...
public enum DittoLettoAsset {
  ...
  public enum Image {
    ...
    public static let backChevron = DittoLettoImages(name: "backChevron")
    ...
    public static let diaryOff = DittoLettoImages(name: "diary_off")
    public static let diaryOn = DittoLettoImages(name: "diary_on")
    public static let emptyFolder = DittoLettoImages(name: "emptyFolder")
    public static let homeOff = DittoLettoImages(name: "home_off")
    public static let homeOn = DittoLettoImages(name: "home_on")
    ...
    public static let personOff = DittoLettoImages(name: "person_off")
    public static let personOn = DittoLettoImages(name: "person_on")
